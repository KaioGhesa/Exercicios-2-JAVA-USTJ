...
public class Exercicio_I {
    public static void main(String[] args) {
        ...
        if (ano1>ano2){
            System.out.println("A primeira pessoa e mais velha: " + dia1 + "/" + mes1 + "/" + ano1);
        }else if (ano1<ano2) {
            System.out.print("A segunda pessoa e mais velha" + dia2 + "/" + mes2 + "/" + ano2);
        }else {
        if (mes1>mes2){
            System.out.println("A primeira pessoa e mais velha: " + dia1 + "/" + mes1 + "/" + ano1);
        } else if (mes1<mes2){
        System.out.print("A seguunda pessoa e mais velha " + dia2 + "/" + mes2 + "/" + ano2);
        }
        else {
                if (dia1>dia2){
                 System.out.print("A primeira pessoa e mais velha " + dia2 + "/" + mes2 + "/" + ano2);
                    }else if (dia2>dia1){
                        System.out.print("A seguunda pessoa e mais velha " + dia2 + "/" + mes2 + "/" + ano2);   
                            }
                   else {
